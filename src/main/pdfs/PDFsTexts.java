...
import static main.common.Commands.PDFlite_Text;
 ...
 * @author MManolas
 */
public class PDFsTexts extends javax.swing.JFrame implements DropTargetListener{
...
String CMD_final=PDFlite_Text()+TextAreaFiles_String();
...
try {
  ...
  public void dropActionChanged(DropTargetDragEvent dtde) {
    ...
    private void initComponents() {
        ...
        setTitle(".:: CamsDiag PDF Creator - "+UserInfo.Get_UserName()+" - "+UserInfo.Get_ComputerName()
            +" ::.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PDFsTexts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
